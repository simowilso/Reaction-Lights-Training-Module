...
/*replaceValueHere*/ #define MY_ECU 3     //ECU number
...
dataPacketPartner partnerLocal = { 1, 3, 0 };
uint8_t dataPartnerReceived = 1;
...
void initReceiverAddress(void) {
  ...
  Serial.println(packetSettings.training_NrOfEcus);
